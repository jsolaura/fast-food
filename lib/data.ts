const dummyData = {
    ...
    customizations: [
        // Toppings
        { name: "Extra Cheese", price: 2000, type: "topping" },
        { name: "Jalapeños", price: 500, type: "topping" },
        { name: "Onions", price: 500, type: "topping" },
        { name: "Olives", price: 500, type: "topping" },
        { name: "Mushrooms", price: 1500, type: "topping" },
        { name: "Tomatoes", price: 1000, type: "topping" },
        { name: "Bacon", price: 2000, type: "topping" },
        { name: "Avocado", price: 2000, type: "topping" },

        // Sides
        { name: "Coke", price: 2000, type: "side" },
        { name: "Fries", price: 3000, type: "side" },
        { name: "Garlic Bread", price: 4000, type: "side" },
        { name: "Chicken Nuggets", price: 5000, type: "side" },
        { name: "Iced Tea", price: 2500, type: "side" },
        { name: "Salad", price: 4000, type: "side" },
        { name: "Potato Wedges", price: 4000, type: "side" },
        { name: "Mozzarella Sticks", price: 4000, type: "side" },
        { name: "Sweet Corn", price: 2500, type: "side" },
        { name: "Choco Lava Cake", price: 4000, type: "side" },
    ],
